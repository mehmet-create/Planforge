...
urlpatterns = [
    ...
    path("<slug:org_slug>/members/<int:user_id>/remove/", views.org_remove_member, name="remove_member"),
    path("<slug:org_slug>/members/<int:user_id>/role/", views.org_change_member_role, name="change_member_role"),
]